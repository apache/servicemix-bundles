...
POMS="
 ...
 nexus/content/repositories/releases/net/shibboleth/utilities/java-support/$JAVASUPPORT_VER2/java-support-$JAVASUPPORT_VER2.pom
 nexus/content/repositories/releases/net/shibboleth/parent/$PARENT_VER/parent-$PARENT_VER.pom
 nexus/content/repositories/releases/net/shibboleth/ext/spring-extensions/$SPRINGEXT_VER/spring-extensions-$SPRINGEXT_VER.pom"
